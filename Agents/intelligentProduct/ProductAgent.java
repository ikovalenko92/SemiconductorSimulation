 ...
 *
 */
public class ProductAgent implements ProductAgentIntf{
	...
	public ProductAgent(Part part, ArrayList<String> processesNeeded, ResourceAgent startingResource, 
	...
	/* (non-Javadoc)
	 * @see intelligentProduct.ProductAgentIntf#getPartName()
	 */
