...
for testIndex = 1:5
    ...
    results1 = readtable(['T' num2str(testIndex) 'outFile100000.0.txt']);
    results2 = readtable(['T' num2str(testIndex) 'outFile150000.0.txt']);
    results3 = readtable(['T' num2str(testIndex) 'outFile200000.0.txt']);
    ...
    elseif (size(results2.Var5,1)==5)
       results.data2 = [results.data2; [results2.Var5' 0]];
    else
